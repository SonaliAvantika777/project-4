...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String,String>map) {
		...
		msg.append("<P>Congatulations for registering on ORS! You can now access your ORS account online - anywhere,anytime and enjoy the flexibility to check the Marksheet Details.</P>");
		msg.append("<P>Log in today at <a href = 'htttp://ors.sunraystechnologies.com'>http://ors.sunraystechnologies.com</a> with your following credentials:</P>");
		msg.append("<P><B>Login Id:"+map.get("login")+"<BR>"+"Password:"+map.get("password")+"</B></P>");
		msg.append("<P>As a secuirity measure, we recommended that you change your password after you first log in.</P>");
		msg.append("<p>For any assistance, please feel free to call us at +91 9827360504 or 0731-4249244 helpline numbers.</p>");
		...
		msg.append("<P><a href='http://www.sunrays.co.in'>-SUNRAYS Technologies</a></P>");
	...
	public static String getForgetPasswordMessage(HashMap<String,String>map) {
         ...
         */
		msg.append("<p><B>To access account user Login Id : "+map.get("login")+"<BR>"+"Password:"+map.get("password")+"</BR></P>");
		msg.append("</BODY></HTML>");
		return msg.toString();
	}
	  /**
