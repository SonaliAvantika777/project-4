...
public class StudentModel {
	...
	public void delete(StudentBean bean) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException("Exception : Exceptiion in delete Student");
		} finally {
			JDBCDataSource.closeConnection(conn);
		}
	...
	public void update(StudentBean bean) throws ApplicationException, DuplicateRecordException {
		...
		// check if update rollno already exist
	...
	public List search(StudentBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			log.error("Database Exception...e");
			throw new ApplicationException("Exception: Exception in getting search Student");
